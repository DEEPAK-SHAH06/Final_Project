...
cur.execute("INSERT INTO users (name, email, password, role) VALUES (?, ?, ?, ?)", ('Owner Three', 'owner3@example.com', 'owner123', 'owner'))
...
cur.execute("INSERT INTO rooms (hotel_id, type, price, is_available) VALUES (?, ?, ?, ?)", (2, 'King Size', 840, 1))
